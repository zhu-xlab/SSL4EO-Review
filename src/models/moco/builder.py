...
class MoCo(nn.Module):
    ...
    def __init__(self, base_encoder, dim=128, K=65536, m=0.999, T=0.07, mlp=False, bands='all'):
        ...
        if bands=='all':
            ...
            self.encoder_q.conv1 = torch.nn.Conv2d(10,64,kernel_size=(3,3),stride=(1,1),padding=(1,1),bias=False)
            self.encoder_k.conv1 = torch.nn.Conv2d(10,64,kernel_size=(3,3),stride=(1,1),padding=(1,1),bias=False)
