...
#SBATCH --output=srun_outputs/B12_train_bt_rn50_%j.out
#SBATCH --error=srun_outputs/B12_train_bt_rn50_%j.err
...
--print-freq 100 \
--checkpoint-dir /p/project/hai_dm4eo/wang_yi/ssl4eo-review/src/checkpoints/barlowtwins/B12_rn50 \
--backbone resnet50 \
--dist_url $dist_url \
--cos \
