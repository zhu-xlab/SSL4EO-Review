...
#SBATCH --output=srun_outputs/B10_lc_simsiam_rn18_10_%j.out
#SBATCH --error=srun_outputs/B10_lc_simsiam_rn18_10_%j.err
...
--bands B10 \
--checkpoints_dir /p/project/hai_dm4eo/wang_yi/ssl4eo-review/src/checkpoints/so2sat/simsiam_lc/B10_LC_simsiam_rn18_10 \
--save_path /p/project/hai_dm4eo/wang_yi/ssl4eo-review/src/checkpoints/so2sat/simsiam_lc/B10_LC_simsiam_rn18_10.pth.tar \
--backbone resnet18 \
--train_frac 0.1 \
--batchsize 256 \
--lr 2 \
