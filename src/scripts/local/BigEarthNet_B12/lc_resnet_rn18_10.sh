...
--checkpoints_dir /mnt/d/codes/ssl4eo-review/src/checkpoints/resnet_lc/B12_rn18_10 \
--save_path /mnt/d/codes/ssl4eo-review/src/checkpoints/resnet_lc/bigearthnet_B12_LC_random_rn18_10.pth.tar \
--backbone resnet18 \
--bands all \
--train_frac 0.1 \
--batchsize 256 \
