...
--checkpoints_dir /mnt/d/codes/ssl4eo-review/src/checkpoints/resnet_lc/B12_rn50_100 \
--save_path /mnt/d/codes/ssl4eo-review/src/checkpoints/resnet_lc/bigearthnet_B12_LC_random_rn50_100.pth.tar \
--backbone resnet50 \
--bands all \
--train_frac 1.0 \
--batchsize 256 \
