...
### fine tuning
parser.add_argument('--lr_last_layer', type=float, default=0.2)
...
def main():
    ...
    optimizer = torch.optim.SGD([{'params': trunk_parameters},{'params': head_parameters, 'lr': args.lr_last_layer}], lr=args.lr, momentum=0.9,weight_decay=0)
